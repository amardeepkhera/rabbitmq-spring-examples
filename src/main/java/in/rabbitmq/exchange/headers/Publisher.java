...
public class Publisher {
    ...
    public void publishMessageFromIndianMale() {
        ...
        rabbitTemplate.convertAndSend("spring-boot-rabbitmq-examples.headers", "routing_key.which_will_be_ignored.because_exchange_type_is.headers", sampleRequestMessage, message -> {
    ...
    public void publishMessageFromAmericanFemale() {
        ...
        rabbitTemplate.convertAndSend("spring-boot-rabbitmq-examples.headers", "", sampleRequestMessage, message -> {
